...
function IssueTrackerDataTable(props) {
    const rowBg = (key) => {
        ...
        return(
            <>
                <tr key={ uniqid() } className='d-flex'>
                    ...
                    <td className={ rowBg(key)+' col-3' } key={ uniqid() }>{ item.ts_stepNum }</td>
                    <td className={ rowBg(key)+' col-3' } key={ uniqid() }>{ item.tse_issue_id }</td>
                </tr>
            </>
        )
    }
        ...
        <table border="1" className='sub-tbl'  key={ uniqid() }>
            ...
            <thead  key={ uniqid() }>
                <tr key={ uniqid() } className='d-flex'>
                    ...
                    <th key={ uniqid() } className='col-3'>Step #</th>
                    <th key={ uniqid() } className='col-3'>Issue ID</th>
                </tr>
            </thead>
            <tbody  key={ uniqid() }>
...
export default IssueTrackerDataTable;