...
function ScenarioReplication() {
    ...
    const callSearch = () => {
        ...
        PostData('search-scenario-reassigned', payload, true).then((result) => {
    ...
    const duplicate = ()=>{
        if(details.length >= 1){
            ...
            PostData('scenario-reassigned', payload, true).then((result) => {
            ...
            <Row className="top-15 separator-border">
                <Col xs={12} md={12}>
                    ...
                    <div className="col-lg-12 col-sm-12 top-10 mb-10 ">
                        ...
                        <PageTitle title="TC Execution Update"/>
                    </div>
                </Col>
            </Row>
